...
<body>
    ...
    <script>
        ...
        // Auto-completar lugar según modalidad
        document.getElementById('modalidad').addEventListener('change', function() {
            const lugar = document.getElementById('lugar');
            const modalidad = this.value;
            
            if (modalidad === 'virtual' && !lugar.value) {
                lugar.placeholder = 'Plataforma virtual (Zoom, Teams, etc.)';
            } else if (modalidad === 'presencial' && !lugar.value) {
                lugar.placeholder = 'Dirección física del evento';
            } else if (modalidad === 'hibrida' && !lugar.value) {
                lugar.placeholder = 'Dirección física + plataforma virtual';
            }
        });
    </script>
</body>
